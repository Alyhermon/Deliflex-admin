...
export default function FinancePickerPage() {
    ...
    <AdminLayout>
      <div className={styles.container}>
        <div className={styles.header}>
          <h1>Finanzas</h1>
          <p>Elige el negocio del que quieres ver las finanzas.</p>
        </div>
          ...
          <div className={styles.empty}>
            ...
            <p>
              {esSuperAdmin
                ...
                : "Todavia no tienes negocios asignados."}
            </p>
          </div>
        ) : (
          <div className={styles.grid}>
            {stores.map((store) => (
              <div
                ...
                onClick={() => router.push(`/finanzas/${store.id}`)}
              >
                ...
                <div className={styles.body}>
                  ...
                  <span className={styles.link}>
                    Ver finanzas <FontAwesomeIcon icon={faArrowRight} size="2xs" />
                  </span>
                </div>
              </div>
            ))}
